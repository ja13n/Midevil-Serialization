...
public class MedievalGame {
    ...
    private Player start(Scanner console) {
        ...
        Player player;
        Art.homeScreen();
        System.out.println("Welcome to the medieval game! would you like to start a new game or load a saved game? Enter 'y' or 'n'. ");
    ...
    private Player load(String playerName, Scanner console){
        ...
        Player loadedPlayer;
        try {
            FileInputStream player = new FileInputStream(playerName + ".svr");
            ObjectInputStream obj = new ObjectInputStream(player);
            loadedPlayer = (Player) obj.readObject();
        }
